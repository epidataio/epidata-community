...
c.NotebookApp.certfile = u'/etc/ssl/certs/epidata_self_signed.crt'
...
#c.NotebookApp.extra_static_paths = ['./custom.cs']
...
c.NotebookApp.keyfile = u'/etc/ssl/certs/epidata_self_signed.key'
...
c.NotebookApp.notebook_dir = u'/var/local/epidata/'
...
c.NotebookApp.tornado_settings = {
    'headers': {
        'Content-Security-Policy': "frame-ancestors https://server_base_url 'self' "
    }
}
